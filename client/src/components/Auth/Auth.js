...
export default class Auth {
  auth0 = new auth0.WebAuth({
    ...
    redirectUri: process.env.REACT_APP_AUTH0_CALLBACK || LOCALHOST_CALLBACK, // || 'http://localhost:3000/callback', // || process.env.AUTH0_CALLBACK || , // 'https://cicerowned.herokuapp.com/callback'
